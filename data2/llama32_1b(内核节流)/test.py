...
# =================配置区域=================
TRACE_FILE = 'raw_thermal_trace_20260323_004112.csv'
LOG_FILE = 'raw_inference_log_20260323_004112.csv'
...
ax1.set_title(f'Llama3.2 : 1b    热演化与性能衰减过程 (T_golden = {t_golden:.1f}s)', fontsize=14, pad=10)
...
ax_phase.set_title('Llama3.2 : 1b    温度 - 频率耦合关系相平面', fontsize=14)
